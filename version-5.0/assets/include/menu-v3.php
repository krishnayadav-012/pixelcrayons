      ...
      <div class="header-item-center">
        <nav class="menu mob-nav" id="menu">
          ...
          <ul>
            <li class="menu-item-has-children">
              ...
              <div class="menu-mega container">
                ...
                <div class="container w-14 soft-eng" id="m-product-engineering">
                  <div class="dis-flex">
                    ...
                    <div class="flex-3 single-an">
                      ...
                      <a href="<?php echo $site_url; ?>services/software-engineering/mobile-app-development/cross-platform"><span class="title">Cross-Platform App Development</span></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="container w-small demand-teams" id="digital-transform">
                  <div class="dis-flex">
                    <div class="flex-3">
                      <a href="<?php echo $site_url; ?>services/digital-transformation/consulting"><span class="title">Consulting</span> Envision tomorrow's tech</a>
                      <a href="<?php echo $site_url; ?>services/digital-transformation/cloud-services"><span class="title">Cloud Services</span> Elevate to cloud efficiency</a>
                      <a href="<?php echo $site_url; ?>services/digital-transformation/machine-learning"><span class="title">Machine Learning</span> Learn, adapt, innovate</a>
                      <a href="<?php echo $site_url; ?>services/digital-transformation/workflow-automation"><span class="title">Workflow Automation </span> Automate for agile operations</a>
                    </div>
                    <div class="flex-3">
                      ...
                      <a href="<?php echo $site_url; ?>services/digital-transformation/data-analytics"><span class="title">Data Analytics & Insights</span> Discover data-driven decisions</a>
                ...
                <div class=" container w-900 landing-menu ecom" id="m-ecommerce">
                  <div class="dis-flex">
                    ...
                    <div class="flex-3">
                      ...
                      <a href="<?php echo $site_url; ?>services/ecommerce/migration"><span class="title">Migration</span>
                      Migrate for market success</a>
                      <a href="<?php echo $site_url; ?>services/ecommerce/management"><span class="title">Maintenance & Management</span>
                      Maintain peak performance</a>
                    </div>
                    <!-- 
                      <div class="flex-3">
                ...
                <div class="container w-14 digital-mark" id="m-qaconsult">
                  <div class="dis-flex">
                    ...
                    <div class="flex-3 single-an">
                      ...
                      <a class="d-clr" href="<?php echo $site_url; ?>services/digital-marketing/conversion-rate-optimization"><span class="title">Conversion Rate Optimization</span></a>
                    </div>
                    <div class="flex-3">                
                      <a href="<?php echo $site_url; ?>services/digital-marketing/online-reputation-management"><span class="title">ORM Service</span>Enhance reputation, build trust
                      </a>                 
                      ...
                      <a href="<?php echo $site_url; ?>services/digital-marketing/ecommerce/amazon"><span class="title">Amazon Marketing</span>Dominate the Amazon marketplace
                      </a>
                      <a href="<?php echo $site_url; ?>services/digital-marketing/email"><span class="title">Email Marketing</span>
                      Transform connections into conversions</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="container w-200 agencies" id="m-agencies">
                  <div class="flex-3">
                    ...
                    Operate securely and reliably</a>
                    <a href="<?php echo $site_url; ?>services/dedicated-teams/staff-augmentation"><span class="title">Staff Augmentation Services</span>
                      ...
                      <div class="right-tabs list-two">
                          ...
                          <div class="tab-text">
                            <div class="column">
                              <ul>
                                ...
                                <li><a href="<?php echo $site_url; ?>hire/api-developers">API</a></li>
                            ...
                            <div class="column">
                              <ul>
                                <li><a href="<?php echo $site_url; ?>hire/symfony-developers">Symfony</a></li>
                                <li><a href="<?php echo $site_url; ?>hire/web-developers">Web</a></li>
                                ...
                                <li><a href="<?php echo $site_url; ?>hire/laravel-developers">Laravel</a></li>
                              </ul>
                            </div>
                          </div>
                          ...
                          <div class="tab-text">
                            <div class="column full">
                              <ul>
                                ...
                                <li><a href="<?php echo $site_url; ?>hire/next-developers">Next</a></li>
                                <li><a href="<?php echo $site_url; ?>hire/typescript-developers">TypeScript</a></li>
                          ...
                          <div class="tab-text">
                            <div class="column full">
                              <ul>
                                ...
                                <li><a href="<?php echo $site_url; ?>hire/seo-experts" title="Hire SEO Expert">SEO (Search Engine Optimization)</a></li>
                          ...
                          <div class="tab-text">
                            <div class="column full">
                              <ul>
                                ...
                                <li><a href="<?php echo $site_url; ?>hire/shopify-developers">Shopify </a></li>
                                ...
                                <li><a href="<?php echo $site_url; ?>services/strapi-development" title="Strapi">Strapi</a>
                                <li>
                              </ul>
                            </div>
                          </div>
                          ...
                          <div class="tab-text">
                            <div class="column full">
                              <ul>
                                ...
                                <li><a href="<?php echo $site_url; ?>hire/flutter-developers" title="Flutter">Flutter</a></li>
                                <li><a href="<?php echo $site_url; ?>hire/iphone-app-developers" title="iOS">iOS</a></li>
                        ...
                        <div class="tab-content">
                          <div class="tab-text">
                            <div class="column full">
                              <ul>
                                <li><a href="<?php echo $site_url; ?>hire/aws-developers">AWS</a>
                                </li>
                                <li><a href="<?php echo $site_url; ?>hire/azure-developers">Azure</a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="tab-content">
                          <div class="tab-text">
                            <div class="column full">
                              <ul>
                                <li><a href="<?php echo $site_url; ?>hire/dot-net-core-developers">.NET Core</a>
                                </li>
                                <li><a href="<?php echo $site_url; ?>hire/django-developers">Django</a></li>
            ...
            <li class="menu-item-has-children">
              <a href="<?php echo $site_url; ?>services/agencies/white-label">For Agencies</a> <span class="arrow-btn"></span>
              <div class="menu-mega container">
                <div class="container w-80 landing-menu" id="landing-menu-fa">
                  <div class="dis-flex">
                    <div class="w-66">
                      <div class="flex-3">
                        ...
                        <!-- <a href="<?php echo $site_url; ?>services/agencies/white-label"><img src="<?php echo $tpl_url; ?>/menu-images/agencies-01.svg" class="menuicon" alt="menuicon"><span class="title">White Label Services</span>
                          ...
                          <a href="<?php echo $site_url; ?>services/dedicated-teams/staff-augmentation"><img src="<?php echo $tpl_url; ?>/menu-images/agencies-07.svg" class="menuicon" alt="menuicon"><span class="title">Staff Augmentation Services</span>
                          Get access to top talent for your business</a> -->
                      </div>
                    </div>
                  </div>
                ...
                <div class="container w-80 landing-menu industry-menu">
                  <div class="dis-flex">
                    <div class="flex-3">
                      ...
                      <a href="<?php echo $site_url; ?>industries/hi-tech"><img src="<?php echo $tpl_url; ?>/menu-images/indus-03.svg" class="menuicon" alt="menuicon"><span class="title">Software & Tech</span>
                      ...
                      <a href="<?php echo $site_url; ?>industries/travel-hospitality"><img src="<?php echo $tpl_url; ?>/menu-images/indus-05.svg" class="menuicon" alt="menuicon"><span class="title">Travel & Hospitality</span>
            ...
            <li class="menu-item-has-children">
              ...
              <div class="menu-mega container">
                <div class="container w-14  landing-menu dm-industry-menu">
                  <div class="dis-flex">
                    <div class="flex-3">
                      <a href="<?php echo $site_url; ?>pending"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-01.svg" class="menuicon" alt="menuicon"><span class="title">Automotive & Transportation</span>
                      Lorem ipsum dolor sit amet, consectetur</a>
                      <a href="<?php echo $site_url; ?>services/digital-marketing/education"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-02.svg" class="menuicon" alt="menuicon"><span class="title">Education</span>
                      Reach students & grow enrollment</a>
                      <a href="<?php echo $site_url; ?>pending"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-03.svg" class="menuicon" alt="menuicon"><span class="title">Finance</span>
                      Lorem ipsum dolor sit amet, consectetur</a>
                      <a href="<?php echo $site_url; ?>pending"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-04.svg" class="menuicon" alt="menuicon"><span class="title">Food & Beverage</span>
                      Lorem ipsum dolor sit amet, consectetur</a>
                      <a href="<?php echo $site_url; ?>pending"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-05.svg" class="menuicon" alt="menuicon"><span class="title">Home Repair</span>
                      Lorem ipsum dolor sit amet, consectetur</a>
                    </div>
                    <div class="flex-3">
                      <a href="<?php echo $site_url; ?>pending"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-06.svg" class="menuicon" alt="menuicon"><span class="title">Industrial</span>
                      Lorem ipsum dolor sit amet, consectetur</a>
                      <a href="<?php echo $site_url; ?>services/digital-marketing/education"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-07.svg" class="menuicon" alt="menuicon"><span class="title">Insurance</span>
                      Reach students & grow enrollment</a>
                      <a href="<?php echo $site_url; ?>services/digital-marketing/legal"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-08.svg" class="menuicon" alt="menuicon"><span class="title">Legal</span>
                      Attract clients & build your reputation</a>
                      <a href="<?php echo $site_url; ?>pending"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-09.svg" class="menuicon" alt="menuicon"><span class="title">Local Services</span>
                      Lorem ipsum dolor sit amet, consectetur</a>
                      <a href="<?php echo $site_url; ?>/services/digital-marketing/health"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-10.svg" class="menuicon" alt="menuicon"><span class="title">Medical & Health</span>
                      Connect with patients & build trust</a>
                    </div>
                    <div class="flex-3">
                      <a href="<?php echo $site_url; ?>pending"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-11.svg" class="menuicon" alt="menuicon"><span class="title">Professional Services</span>
                      Lorem ipsum dolor sit amet, consectetur</a>
                      <a href="<?php echo $site_url; ?>services/digital-marketing/education"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-12.svg" class="menuicon" alt="menuicon"><span class="title">Real Estate</span>
                      Reach students & grow enrollment</a>
                      <a href="<?php echo $site_url; ?>services/digital-marketing/legal"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-13.svg" class="menuicon" alt="menuicon"><span class="title">Retail & Ecommerce</span>
                      Attract clients & build your reputation</a>
                      <a href="<?php echo $site_url; ?>services/digital-marketing/tech"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-14.svg" class="menuicon" alt="menuicon"><span class="title">Tech</span>
                      Future-proof your tech brand</a>
                      <a href="<?php echo $site_url; ?>services/digital-marketing/tourism-hospitality"><img src="<?php echo $tpl_url; ?>/menu-images/inicon-15.svg" class="menuicon" alt="menuicon"><span class="title">Tourism & Hospitality</span>
                      Reach travelers online, boost bookings</a>
                    </div>
                  </div>
                </div>
              </div>
