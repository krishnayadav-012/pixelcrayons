...
<html lang="en">
   ...
   <body id="themeAdd" class="home">
      ...
      <div class="content-marketing-roi">
         <div class="container">
             ...
             function calculateROI() {
               ...
               const resultHTML = `
                 <div class="result">
                   ...
                   <br><br>
                   <button class="btn btn-green">Download results PDF</button>
                 </div>
                 <div class="result-grid">
                   <div><strong>Expected price per post:</strong><br>$${expectedValue.toLocaleString()}</div>
                   <div><strong>Posts after one year:</strong><br>${yearlyPosts}</div>
                   <div><strong>Annual content marketing budget:</strong><br>$${annualBudget.toLocaleString()}</div>
                   <div><strong>Estimated added monthly traffic value in 12 months:</strong><br>$${addedMonthlyValue.toLocaleString()}</div>
                   <div><strong>Estimated added traffic value to the year after campaign start:</strong><br>$${addedYearlyValue.toLocaleString()}</div>
                   <div><strong>Estimated added monthly traffic in 12 months:</strong><br>${addedYearlyTraffic.toLocaleString()}</div>
                 </div>
               `;
