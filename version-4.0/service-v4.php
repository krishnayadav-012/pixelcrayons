...
<html lang="en">
  ...
  <body id="themeAdd">
    ...
    <section class="methodologies-section  padding-t-120 padding-b-120">
      <div class="container">
        <div class="top-section">
          <h2>Software Development Methodologies</h2>
          <p>Tailoring the Approach to Your Needs</p>
        </div>
        <div class="dis-flex method-out">
          <div class="flex-4">
            <div class="box-4" style="background-image:url(./assets/images/service-images/method-01.png);">
              <h3>DevOps
              </h3>
              <div class="overlay-text">
                <h3>DevOps
                </h3>
                <p>Embrace the culture of collaboration and continuous improvement with DevOps.</p>
              </div>
            </div>
          </div>
          <div class="flex-4">
