...
<head>
  ...
  <link rel="preload stylesheet" type="text/css" href="assets/css/hire-main.css" defer />
...
<body id="themeAdd" class="home">
  ...
  <section class="hero-section home-top-section text-left padding-t-120 padding-b-120">
    ...
    <div class="container">
      <div class="inner-part">
        <div class="left-part">
          <h1>Dedicated teams.
            In your sprint <em>within 48 hours.</em>
          </h1>
          <p>In-house vetted developers, marketers, designers, and AI engineers - not freelancers sourced from marketplaces. Integrated into your team. Managed by a dedicated PM. Governed by an SLA.</p>
        ...
        <div class="right-part">
          <div class="middle-logo">
            <img src="./assets/images/hire-main/banner-img.webp" alt="">
          </div>
  ...
  <section class="how-it-works padding-t-120  padding-b-120 ">
    <div class="container">
      <div class="hiw-inner">
        ...
        <div class="hiw-right tabbing-part active-pixelcrayons" id="timelineScroll">

          <div class="toggle-container">
            <button type="button" class="toggle-btn active" data-tab="pixelcrayons">Pixelcrayons</button>
            <button type="button" class="toggle-btn" data-tab="typical">Typical</button>
          </div>
          ...
          <div class="timeline typical-data">
            <div class="timeline-progress" id="timelineProgress"></div>
  ...
  <!-- deliv -problam -->
  <section class="fintech-delivery padding-t-120  padding-b-120 vertical-slide">
    <div class="grid-lines">
      <img src="assets/images/brand/blue-g-f.png" alt="">
    </div>
    <div class="container">
      <div class="inner-part">
        <div class="left-part">
          <em>What Teams Say</em>
          <h2>Agencies and brands on what <em>dedicated hiring</em> actually feels like.</h2>
          <p>Most partners promise not to compete with you. We've made it structurally impossible. Separate business units.</p>
            ...
            <div class="cards-track">
              ...
              <div class="review-card">
                ...
                <div class="user">
                  ...
                  <div>
                    <h4>Sarah Okonkwo</h4>
                    <span>VP Engineering, Meridian Labs</span>
                  </div>
                </div>
              ...
              <div class="review-card">
                ...
                <div class="user">
                  ...
                  <div>
                    <h4>James Okafor</h4>
                    <span>Managing Director, Koda Creative</span>
                  </div>
                </div>
              ...
              <div class="review-card">
                ...
                <div class="user">
                  ...
                  <div>
                    <h4>Emily Carter</h4>
                    <span>Founder, Nova Digital</span>
                  </div>
                </div>
              ...
              <div class="review-card">
                ...
                <div class="review-text">
                  The React engineer they placed was better than
                  anyone we interviewed directly. Fully integrated
                  with our team on day three.
                </div>
              ...
              <div class="review-card">
                ...
                <div class="review-text">
                  Scaled from one developer to four within a week
                  for a Q4 launch. No ramp time.
                </div>
