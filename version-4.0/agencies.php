...
<body id="themeAdd" class="home">
      ...
      <div class="inner-part">
        ...
        <div class="right-part">
          <div class="middle-logo">
            <img src="assets/images/agencies/banner-img.webp" alt="">
          </div>
    ...
    <div class="container">
      <div class="inner-part">
        <div class="left-part">
          ...
          <p><span style="font-weight: 400;">The real challenge isn’t speed. It’s shipping fast while staying compliant, secure, and audit-ready.</span></p>
          <p><span style="font-weight: 400;">That’s where most delivery systems start to break.</span></p>
  ...
  <!-- tabing section  -->
  <section class="vertical-tabs padding-t-120  padding-t-120 ">
    <div class="container">

      <!-- Heading -->
      <div class="vertical-tabs__heading">
        <h2>One partner. <em>Every discipline.</em></h2>
        <p>20+ services across marketing, development, design and AI. Your clients stop seeing gaps in your offering. You stop managing four separate providers to fill them.</p>
      </div>
        ...
        <div class="vertical-tabs__content">
          ...
          <div class="vertical-tabs__panel active" id="services-panel-marketing">
            <div class="vertical-tabs__panel-header">
              ...
              <p>Paid media, SEO, content, email, and CRO — all delivered under your brand with weekly performance reporting branded to your agency.</p>
            </div>
            <div class="vertical-tabs__grid">
              <div class="vertical-tabs__card">
                <div class="vertical-tabs__card-title">
                  <h4>Paid Media — Google & Meta</h4>
                </div>
                <p>Strategy, campaign build, ongoing optimisation, and white-label reporting.</p>
              </div>
              <div class="vertical-tabs__card">
                <div class="vertical-tabs__card-title">
                  <h4>SEO & Content</h4>
                </div>
                <p>Technical SEO, on-page, link building, and content strategy — under your brand.</p>
              </div>
              <div class="vertical-tabs__card">
                <div class="vertical-tabs__card-title">
                  <h4>Email & Marketing Automation</h4>
                </div>
                <p>Klaviyo, HubSpot, ActiveCampaign — lifecycle and transactional execution.</p>
              </div>
              <div class="vertical-tabs__card vertical-tabs__card--featured">
                <div class="vertical-tabs__card-title">
                  <h4>Analytics & Reporting</h4>
                </div>
                <p>GA4, dashboards, attribution models, all reporting white-labelled to your agency.</p>
              </div>
              <div class="vertical-tabs__card">
                <div class="vertical-tabs__card-title">
                  <h4>Conversion Rate Optimisation</h4>
                </div>
                <p>A/B testing, landing page work, and funnel analysis tied to client revenue.</p>
              </div>
              <div class="vertical-tabs__card">
                <div class="vertical-tabs__card-title">
                  <h4>ECommerce Marketing</h4>
                </div>
                <p>Shopping campaigns, feed management, and D2C growth execution.</p>
              </div>
            </div>
          </div>
