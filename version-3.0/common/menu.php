<?php 
  ...
  $tpl_url    = 'https://www.pixelcrayons.com/wp-content/themes/pixelcrayons';
  ?>
<?php //if( !vc_is_mobile() ) : ?>
        ...
        <a href="<?php echo $site_url; ?>" class="brand">
          <div class="large">
            <picture class="for-white-logo">
              <img loading="lazy" src="<?php bloginfo('template_url'); ?>/assets/images/hire/white-logo.svg" alt="Pixelcrayons" 
                width="308" height="64">
            </picture>
            <picture class="for-dark-logo">
              <img loading="lazy" src="<?php bloginfo('template_url'); ?>/assets/images/hire/dark-blue-logo.svg" alt="Pixelcrayons" width="308" height="64">
            </picture>
          </div>
          <div class="small">
            <img loading="lazy" src="<?php bloginfo('template_url'); ?>/assets/images/logo-small.svg" alt="Pixelcrayons" 
                  ...
                  <div class="width-35 header-menu" id="b3">
                    <div class="dis-flex" id="active_Current_Tabs3">
                      <div class="width-60 middle-list">
                        ...
                        <a href="<?php echo $site_url; ?>ecommerce-consulting-services" class="text-column">eCommerce Consulting</a>
  ...
  <div class="container">
    <div class="header-top">
      <a href="<?php echo $site_url; ?>" class="mobile-logo">
        <picture>
          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/assets/images/hire/logo.svg" alt="Pixelcrayons" 
            width="170" height="50">  
        </picture>
      </a>
      <?php if( !isset( $_GET['l'] ) ) : ?>
    ...
    <nav class="mob-nav">
      ...
      <picture>
        ...
        <ul>
          <li><a href="<?php echo $site_url; ?>custom-software-development-services">Services</a>
            <span class="arrow-btn" onclick="submenu()"></span>
          </li>
          <li>
            <a href="<?php echo $site_url; ?>dedicated-development-teams">Remote Teams</a> <span class="arrow-btn parrow"
              onclick="innermenu(this, 'main0')"></span>
            <div class="first-inner hire-title" id="main0">
              <a href="<?php echo $site_url; ?>hire-web-developers">Backend</a> <span class="arrow-btn" onclick="innermenu(this, 'main01')"></span>
              ...
              <div>
                <a href="<?php echo $site_url; ?>hire-frontend-developer">Frontend</a>
              ...
              <div>
                <a href="<?php echo $site_url; ?>hire-mobile-app-developers" class="margin-t-40">Mobile</a> <span class="arrow-btn"
                  onclick="innermenu(this, 'main05')"></span>
                <div class="hire-inner" id="main05">
                  <a href="<?php echo $site_url; ?>hire-iphone-app-developer" title="iOS">iOS</a>
                  <a href="<?php echo $site_url; ?>hire-android-developers" title="Android">Android</a>
                  <a href="<?php echo $site_url; ?>hire-kotlin-developers" title="Kotlin">Kotlin</a>
                  <a href="<?php echo $site_url; ?>flutter-app-development-company-india" title="Flutter">Flutter</a>
                  <a href="<?php echo $site_url; ?>hire-react-native-developers" title="React Native">React Native</a>
                </div>
              </div>
              <div>
                <a href="<?php echo $site_url; ?>hire-dedicated-full-stack-developers" class="margin-t-40">Full Stack</a> <span class="arrow-btn"
                  onclick="innermenu(this, 'main03')"></span>
                <div class="hire-inner" id="main03">
                  <a href="<?php echo $site_url; ?>hire-laravel-developers" title="Laravel">Laravel</a>
                  <a href="<?php echo $site_url; ?>mean-stack-development" title="MEAN">MEAN</a>
                  <a href="<?php echo $site_url; ?>mern-stack-development" title="MERN">MERN</a>
                </div>
              </div>
              <div>
                <a href="<?php echo $site_url; ?>cms-development">CMS</a> <span class="arrow-btn" onclick="innermenu(this, 'main06')"></span>
              ...
              <div>
                <a href="<?php echo $site_url; ?>hire-digital-online-marketing-experts">Digital Marketing</a>
              ...
              <div>
                <a href="<?php echo $site_url; ?>hire-blockchain-developers" class="margin-t-40">Blockchain</a> <span class="arrow-btn"
              ...
              <div>
                <a href="<?php echo $site_url; ?>hire-ecommerce-developer" class="margin-t-40">ECommerce</a> <span class="arrow-btn"
          ...
          <li>
            <a href="#">Technologies</a> <span class="arrow-btn parrow" onclick="innermenu(this, 'main00')"></span>
            <div class="first-inner hire-title" id="main00">
              <a href="javascript:void(0);">Mobility</a> <span class="arrow-btn" onclick="innermenu(this, 'main001')"></span>
              <div class="hire-inner" id="main001">
                <a href="<?php echo $site_url; ?>mobile-app-development/ios-app-development"
                  title="ios">iOS</a>
                <a href="<?php echo $site_url; ?>mobile-app-development/android-development"
                  title="Android">Android</a>
                <a href="<?php echo $site_url; ?>mobile-app-development/xamarin-mobile-app-development"
                  title="Xamarin">Xamarin</a>
                <a href="<?php echo $site_url; ?>mobile-app-development/augmented-reality-development"
                  title="AR / VR">AR / VR</a>
                <a href="<?php echo $site_url; ?>javascript-development/react-native-development"
                  title="React-Native">React-Native</a>
                <a href="<?php echo $site_url; ?>mobile-app-development/flutter-app-development-company-india"
              ...
              <div>
                ...
                <div class="hire-inner" id="main002">
                  <a href="<?php echo $site_url; ?>javascript-development/angularjs-development"
                    title="Angular">Angular</a>
                  <a href="<?php echo $site_url; ?>javascript-development/reactjs-development"
                    title="ReactJS">ReactJS</a>
                </div>
              </div>
              <div>
                <a href="javascript:void(0);" class="margin-t-40">Blockchain</a> <span class="arrow-btn"
              ...
              <div>
                <a href="javascript:void(0);" class="margin-t-40">Backend</a> <span class="arrow-btn"
              ...
              <div>
                <a href="javascript:void(0);">eCommerce & CMS</a> <span class="arrow-btn" onclick="innermenu(this, 'main006')"></span>
          ...
          <li>
            <a href="<?php echo $site_url; ?>">Industries</a> <span class="arrow-btn parrow" onclick="innermenu(this, 'inner5')"></span>
          ...
          <li>
            <a href="<?php echo $site_url; ?>about">Company</a> <span class="arrow-btn parrow"
      ...
      <div class="menu-list second" id="dropdownmwrap">
        <picture>
          <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/hire/logo.webp">
          <source type="image/png" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/hire/logo.png">
          <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/hire/logo.png" alt="Pixelcrayons" width="150" height="35">
        </picture>
